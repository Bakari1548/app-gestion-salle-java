...
-- Script SQLite pour UNIV-SCHEDULER (noms en français)
...
-- Table de liaison salles-équipements
...
-- Table de liaison emploi-équipement
CREATE TABLE emploi_equipement (
                                   emploi_id INTEGER NOT NULL,
                                   equipement_id INTEGER NOT NULL,
                                   PRIMARY KEY (emploi_id, equipement_id),
...
CREATE INDEX idx_emplois_heure ON emplois_du_temps(heure_debut, duree_minutes);
...
INSERT INTO batiments (nom, code, localisation, nombre_etages, description) VALUES
                                                                                ...
                                                                                ('Batiment Sciences', 'BAT-SCI', 'Nord du campus', 3, 'Salles de TP et laboratoires'),
                                                                                ('Batiment Lettres', 'BAT-LET', 'Sud du campus', 2, 'Salles de TD et bibliotheque');
...
-- Association équipements-salles
